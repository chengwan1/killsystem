...
public interface SeckillService {
     ...
     * 执行秒杀
     */
    Result<Integer> doSeckill(long goodsId, String path, HttpServletRequest request,String visitorId);
     ...
     * 返回一个唯一的path的id
     */
    Result<String> getSeckillPath(HttpServletRequest request, long goodsId,String visitorId);
