...
public class SeckillController {
    ...
    public Result<Integer> doSeckill(@RequestParam("goodsId") long goodsId,
        ...
        return seckillService.doSeckill(goodsId, path, request,visitorId);
    }
    ...
    public Result<String> getSeckillPath(HttpServletRequest request, @RequestParam("goodsId") long goodsId,@RequestHeader("X-Visitor-ID") String visitorId) {
        return seckillService.getSeckillPath(request, goodsId, visitorId);
    }
}
